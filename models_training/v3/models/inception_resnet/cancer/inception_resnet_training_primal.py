...
def fit_and_eval_inception_resnet():
    save_model_params_path_primal = fr'../saved_models/i_r_v2_our_dataset_RA_adam_2_layers_sigmoid_combined_crop_gaus_rotate.h5'
    model = create_combined_input_model()
    fit_and_eval_primal('i_r_v2_our_dataset_RA_adam_2_layers_sigmoid_combined_crop_gaus_rotate', model, save_model_params_path_primal)
